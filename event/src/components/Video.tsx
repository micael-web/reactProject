            ...
            <div className="p-8 max-w-[1100] mx-auto">
                <div className="flex items-start gap-16">
                    ...
                    <div className="flex items-center gap-4 mt-6">
                        ...
                        src={data.lesson.teacher.avatar} />
                ...
                <div className="gap-8 mt-20 grid grid-cols-2">
                    ...
                    href="">
                        ...
                        <div className="py-6 leading-relaxed">
                            <strong className="text-2xl">Wallpaper</strong>
                            <p className="text-sn text-gray-200 mt-2">Baixe wallpapaer exclusivos do Ignite Lab e personalize a sua máquina</p>
                        </div>
